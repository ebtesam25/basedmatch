        ...
        <View style={styles.container}>
            <View style={{ marginTop: '10%', marginHorizontal:'5%' }}>
                ...
                paddingLeft:'5%', textAlign:'left', width:'90%', backgroundColor:'#f7d7d7', borderRadius:20, paddingVertical:'5%', fontWeight:'bold'}} placeholderTextColor="#f55f5f"></TextInput>
                 <TextInput placeholder="age" style={{fontFamily:'S', fontSize:20, alignSelf:'center', color:'#F14848', marginTop:'5%',
                paddingLeft:'5%', textAlign:'left', width:'90%', backgroundColor:'#f7d7d7', borderRadius:20, paddingVertical:'5%', fontWeight:'bold'}} placeholderTextColor="#f55f5f"></TextInput>
                 <TextInput placeholder="gender" style={{fontFamily:'S', fontSize:20, alignSelf:'center', color:'#F14848', marginTop:'5%',
                paddingLeft:'5%', textAlign:'left', width:'90%', backgroundColor:'#f7d7d7', borderRadius:20, paddingVertical:'5%', fontWeight:'bold'}} placeholderTextColor="#f55f5f"></TextInput>
                 <TextInput placeholder="sexuality" style={{fontFamily:'S', fontSize:20, alignSelf:'center', color:'#F14848', marginTop:'5%',
                paddingLeft:'5%', textAlign:'left', width:'90%', backgroundColor:'#f7d7d7', borderRadius:20, paddingVertical:'5%', fontWeight:'bold'}} placeholderTextColor="#f55f5f"></TextInput>
                 <TextInput placeholder="religion (optional)" style={{fontFamily:'S', fontSize:20, alignSelf:'center', color:'#F14848', marginTop:'5%',
                paddingLeft:'5%', textAlign:'left', width:'90%', backgroundColor:'#f7d7d7', borderRadius:20, paddingVertical:'5%', fontWeight:'bold'}} placeholderTextColor="#f55f5f"></TextInput>
