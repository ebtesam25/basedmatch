    ...
    return (
        <View style={styles.container}>
           ...
           <View style={{marginHorizontal:'2.5%', marginTop:'5%', width:'90%', alignSelf:'center'}}>
            ...
            <TouchableOpacity onPress={()=>navigation.navigate('Track')}><View style={{marginTop:'5%', width:'40%', backgroundColor:'#6BCF87', marginLeft:'10%', borderRadius:50, display:'flex', flexDirection:'row',  marginLeft:'15%'}}>
